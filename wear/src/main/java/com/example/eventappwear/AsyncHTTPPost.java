...
import static com.example.eventappwear.MainActivity.lat;
import static com.example.eventappwear.MainActivity.lon;

public class AsyncHTTPPost extends AsyncTask<String, Integer, String> {

    private WearableActivity myActivity;

    public AsyncHTTPPost(WearableActivity mainActivity) {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            jsonParam.put("gps_lat", lat);
            jsonParam.put("gps_long", lon);
            jsonParam.put("student_message", "message from Monptellier");
